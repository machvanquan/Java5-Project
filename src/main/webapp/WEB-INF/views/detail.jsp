	...
	<div class="container-fluid py-5">
		<div class="row px-xl-5">
				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner border">
						<div class="carousel-item active">
							<img class="w-100 h-100" src="/images/${pr.image}" alt="Image">
						</div>
			...
			<div class="col-lg-7 pb-5">
				<h3 class="font-weight-semi-bold">${pr.name}</h3>
				<div class="d-flex mb-3">
					...
					<small class="pt-1">(${pr.id} Reviews)</small>
				</div>
				<h3 class="font-weight-semi-bold mb-4">$ ${pr.price}</h3>
				...
				<div class="d-flex align-items-center mb-4 pt-2">
					...
					<a href="/home/cart/add/${pr.id}" class="btn btn-primary px-3">
