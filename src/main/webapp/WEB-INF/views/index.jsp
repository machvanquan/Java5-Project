...
<body>
		...
		<div class="row px-xl-5">
			<div class="col-md-6 pb-4">
				<div
					...
					<img
						src="https://s3-ap-southeast-1.amazonaws.com/kpc-prod-web-static/frontend/microsite/dior/images/mainbanner/20.-Sep-2022-RD-Fvr-Stick-x-KP-Landing-Page-Banner-EN-Website-Desktop-(W2160px-x-H1080px).jpg"
						alt="">
			...
			<div class="col-md-6 pb-4">
				<div
					...
					<img src="https://file.hstatic.net/1000340570/article/savage_274e526c589b4582a675c21fadd09542.png" alt="">
					<div class="position-relative" style="z-index: 1;">
						<h5 class="text-uppercase text-primary mb-3">20% off the all
							order</h5>
	...
	<div class="container-fluid pt-5">
		<div class="text-center mb-4">
			<h2 class="section-title px-5">
				<span class="px-2">Best Seller</span>
			</h2>
		</div>
		<div class="row px-xl-5 pb-3">
			<c:forEach var="item" items="${top8price}">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<div class="card product-item border-0 mb-4">
						...
						<div
							...
							<div class="d-flex justify-content-center">
								<h6>$ ${item.price}</h6>
								<h6 class="text-muted ml-2">(${item.createDate})</h6>
							</div>
						</div>
						<div
	...
	<div class="container-fluid pt-5">
		<div class="text-center mb-4">
			<h2 class="section-title px-5">
				<span class="px-2">Latest Updates</span>
			</h2>
		</div>
		<div class="row px-xl-5 pb-3">
				<c:forEach var="item" items="${top8date}">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<div class="card product-item border-0 mb-4">
						<div
							class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
			...
			<div class="col">
				<div class="owl-carousel vendor-carousel">
					<div class="vendor-item border p-4">
						<img src="${pageContext.request.contextPath}/images/anh1.jpg"
							alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="${pageContext.request.contextPath}/images/anh2.jpg"
							alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="${pageContext.request.contextPath}/images/anh3.jpg"
							alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="${pageContext.request.contextPath}/images/anh4.jpg"
							alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="${pageContext.request.contextPath}/images/anh5.jpg"
							alt="">
					</div>
					<div class="vendor-item border p-4">
						<img src="${pageContext.request.contextPath}/images/anh1.jpg"
